<div>
    {{-- Hero Section --}}
    <div
        class="flex items-center justify-center w-full h-screen px-4 py-10 mx-auto bg-gradient-to-r from-blue-200 to-cyan-200 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">BidAuction</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Discover exclusive treasures and unique
                        finds at unbeatable prices – bid now on BidAuction!</p>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-6">
                ...
                @foreach ($categories as $category)
                    <a href="/auctions?selected_categories[0]={{ $category->id }}" wire:key="{{ $category->id }}"
    ...
    <section class="py-20 bg-orange-200">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200"> On Going<span class="text-blue-500">
                            Auctions
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                ...
                @foreach ($ongoingAuctions as $ongoingAuction)
                    <div wire:key="{{ $ongoingAuction->id }}" class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <div class="p-5 text-center">
                            <a href="/auctions/{{ $ongoingAuction->id }}"
    ...
    {{-- End of Latest Auctions Section --}}
