            ...
            <div class="sticky top-0 z-50 overflow-hidden ">
              ...
              <div class="flex-wrap hidden md:flex ">
                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='https://m.media-amazon.com/images/I/71f5Eu5lJSL._SX679_.jpg'">
                  <img src="https://m.media-amazon.com/images/I/71f5Eu5lJSL._SX679_.jpg" alt="" class="object-cover w-full cursor-pointer lg:h-20 hover:border hover:border-blue-500">
                </div>
  
                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='https://m.media-amazon.com/images/I/61XPhYGQOQL._SX679_.jpg'">
                  <img src="https://m.media-amazon.com/images/I/61XPhYGQOQL._SX679_.jpg" alt="" class="object-cover w-full cursor-pointer lg:h-20 hover:border hover:border-blue-500">
                </div>
  
                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='https://m.media-amazon.com/images/I/81v5JNjZ4-L._SX679_.jpg'">
                  <img src="https://m.media-amazon.com/images/I/81v5JNjZ4-L._SX679_.jpg" alt="" class="object-cover w-full cursor-pointer lg:h-20 hover:border hover:border-blue-500">
                </div>
